...
public class FeedbackFragment extends Fragment {
    ...
    private RadioButton pointsEnjoy;
    private String pointsEnjoyChoice;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final RadioGroup pointssEnjoyGroup = v.findViewById(R.id.points_enjoy_group);
        pointssEnjoyGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                pointsEnjoy = pointssEnjoyGroup.findViewById(checkedId);

                switch (checkedId) {
                    case R.id.first_points_enjoy:
                        pointsEnjoyChoice = pointsEnjoy.getText().toString();
                        break;
                    case R.id.second_points_enjoy:
                        pointsEnjoyChoice = pointsEnjoy.getText().toString();
                        break;
                    case R.id.third_points_enjoy:
                        pointsEnjoyChoice = pointsEnjoy.getText().toString();
                        break;
                    case R.id.fourth_points_enjoy:
                        pointsEnjoyChoice = pointsEnjoy.getText().toString();
                        break;
                    case R.id.fifth_points_enjoy:
                        pointsEnjoyChoice = pointsEnjoy.getText().toString();
                        break;
                    case R.id.sixth_points_enjoy:
                        pointsEnjoyChoice = pointsEnjoy.getText().toString();
                        break;
                    default: break;
                }
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (genderGroup.getCheckedRadioButtonId() == -1) {
                ...
                else if (pointssEnjoyGroup.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(getContext(), "Please select at least one of the options", Toast.LENGTH_SHORT).show();
                    focusOnView(scrollView, pointssEnjoyGroup);
                }
                    ...
                    FeedbackObject feedbackObject = new FeedbackObject(genderChoice, ageGroupChoice, previousRecommenders.getText().toString(),
                            ...
                            generatedProfileMatchedChoicesChoice, pointsEnjoyChoice,
